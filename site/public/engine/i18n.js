...
(function (root) {
  const I18N = {
    ja: {
      ...
      'sidebar.behavior.highlight.label': '土日を強調',
      'sidebar.behavior.highlight.desc':  '変換後に土日を色で区別する',
    ...
    en: {
      ...
      'sidebar.behavior.highlight.label': 'Highlight Weekends',
      'sidebar.behavior.highlight.desc':  'Color-code Sat/Sun in output',
      'sidebar.experimental.group':  'Experimental',
